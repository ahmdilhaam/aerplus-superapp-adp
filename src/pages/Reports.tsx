  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const rows = details.map((d) => ({
        ...
        'Jumlah Transaksi Pengantaran': d.laporan.pengantaranGalon.jumlahPengantaranHariIni ?? '',
        'Qty Galon Pengantaran': d.laporan.pengantaranGalon.qtyPengantaranHariIni ?? '',
